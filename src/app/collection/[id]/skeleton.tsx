...
const ProductsFromCollectionSekeleton = () => {
  return (
    <div className="flex flex-col gap-2">
      <div className="h-12 w-1/5 animate-pulse rounded bg-gray-300"></div>
      <div className="h-5 w-1/6 animate-pulse rounded bg-gray-300"></div>
      <div className="grid animate-pulse grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
