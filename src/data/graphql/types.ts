...
// export type GetPageblogpostQuery = {
//   pageBlogPostCollection?:
//     | { items: Array<{ sys: { id: string } } | undefined> }
//     | undefined;
// };

// export const GetPageblogpostDocument = gql`
//   query GetPageblogpost($limit: Int!, $skip: Int!) {
...
//   return {
//     GetPageblogpost(
//       variables: GetPageblogpostQueryVariables,
//       requestHeaders?: GraphQLClientRequestHeaders,
//     ): Promise<GetPageblogpostQuery> {
//       return withWrapper(
//         (wrappedRequestHeaders) =>
//           client.request<GetPageblogpostQuery>(
//             GetPageblogpostDocument,
//             variables,
